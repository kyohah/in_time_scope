---
description: 'Translate README.md into multiple languages (ja, zh, fr, de)'
---
# Translate README

Translate the README.md into multiple languages.
...
3. For each translation:
   ...
   - Keep the language links at the top unchanged
